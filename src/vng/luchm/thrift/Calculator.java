...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2018-02-02")
public class Calculator {

  public interface Iface {

    public int calculate(int num1, int num2, Operation op) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void calculate(int num1, int num2, Operation op, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class calculate_args implements org.apache.thrift.TBase<calculate_args, calculate_args._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_args>   {
     ...
     * @see Operation
     */
    public calculate_args setOp(Operation op) {
      this.op = op;
      return this;
    }
